...
class AdditionalPurchasePricesSeeder extends Seeder
{
    public function run(): void
    {
        $data = [
            ...
            ['id' => 3, 'type' => 'pending_requests', 'unit_price' => '2.00', 'min_quantity' => 1, 'max_quantity' => 100, 'is_active' => 1, 'created_at' => '2026-02-15 17:21:31', 'updated_at' => '2026-02-15 17:21:31']
        ];

        foreach ($data as $row) {
            DB::table('additional_purchase_prices')->updateOrInsert(['id' => $row['id']], $row);
        }
    }
}
