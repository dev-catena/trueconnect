...
class ConexaoAtualizada implements ShouldBroadcast
{
    use Dispatchable, InteractsWithSockets, SerializesModels;

    public $conexao;
    public $acao; // 'aceita', 'rejeitada', 'removida'

    /**
     * Create a new event instance.
     */
    public function __construct(UsuarioConexao $conexao, string $acao = 'atualizada')
    {
